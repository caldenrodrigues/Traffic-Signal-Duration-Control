...
EndPoint_Lane2 = [0,display_height * 0.45]
EndPoint_Lane3 = [display_width * 0.45,0]
EndPoint_Lane4 = [display_width * 0.45,display_height * 0.45]
...
signalPositionLane2 = (display_width * 0.55, display_height * 0.35)
...
def getCurrentPointLane3():
    ...
    if(CurrentPoint_Lane3 == 0):
        ...
        return [display_width * 0.45, display_height*0.4]
    elif(CurrentPoint_Lane3 == 1):
        CurrentPoint_Lane3 = 2
        return [display_width * 0.45 + 30, display_height*0.4]
    else:
        CurrentPoint_Lane3 = 0
        return [display_width * 0.45 + 60, display_height*0.4]
...
def getCurrentPointLane2():
    ...
    if(CurrentPoint_Lane2 == 0):
        ...
        return [display_width * 0.45, display_height*0.4+30]
    else:
        CurrentPoint_Lane2 = 0
        return [display_width * 0.45, display_height*0.4+60]
...
def getDirectionLane1():
    ...
    if CurrentPoint_Lane1 == 1:
        ...
        return random.choice(["Straight", "Right"])
    ...
    if(not current_second == second):
        ...
        for i in data:
            ...
            if(current_time == time.strftime("%H:%M:%S") and i['direction'] == "in"):
                ...
                ListLane1.append({"id":id,"type":i["type"], "direction": getDirectionLane1(), "EndPoint": EndPoint_Lane1, "CurrentPoint": currentPoint})
                id+=1
        for i in data:
            current_time = parser.parse(i['time']).strftime("%H:%M:%S")
            if(current_time == time.strftime("%H:%M:%S") and i['direction'] == "in"):
                currentPoint = getCurrentPointLane2()
                ListLane2.append({"id":id,"type":i["type"], "direction": getDirectionLane2(), "EndPoint": EndPoint_Lane2, "CurrentPoint": currentPoint})
                id+=1
